...
class MovementSystem : IteratingSystem(
    family { all(TransformComponent, MeshComponent) }
) {
    ...
    override fun onTickEntity(entity: Entity) {
        ...
        transformComponent.rotation.rotateAxis(rotationSpeed, 0.5f, 1.0f, 0.0f).normalize()

        transformComponent.position.x = sin(totalTime * 1.5f) * 2.0f
    }
}